    ...
    <div className="bg-base-200 sticky z-10 top-0">
      <div className="navbar max-w-7xl m-auto">
        <div className="navbar-start">
          ...
          <div className="dropdown">
            ...
            >
              ...
              <a href="#services" className="btn text-[#9929FB]">
                <li>{t("navbar.services")}</li>
              </a>
              <a href="#training" className="btn text-[#9929FB]">
                <li>{t("navbar.training")}</li>
              </a>
              <a href="#education" className="btn text-[#9929FB]">
                <li>{t("navbar.education")}</li>
              </a>
          ...
          <div className="flex justify-between items-center gap-2">
            ...
            />
            <a
              className="btn btn-ghost font-semibold text-md text-black lg:text-[32px]"
              href="#home"
            >
              {t("navbar.name")}
            </a>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-6 font-semibold text-[16px] items-center gap-4">
            ...
            <a href="#services" className="btn btn-outline text-[#9929FB]">
              <li>{t("navbar.services")}</li>
            </a>
            <a href="#training" className="btn btn-outline mx-8 text-[#9929FB]">
              <li>{t("navbar.training")}</li>
            </a>
