...
const Footer = () => {
  ...
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <a href="https://www.facebook.com/share/1CvchLAs9a/">
      <FaFacebook className="text-blue-600 text-2xl cursor-pointer hover:text-blue-800 transition" />
    </a>
    <a href="https://www.linkedin.com/in/al-imran-bhuiya-a634a0272?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
 <FaLinkedin className="text-blue-600 text-2xl cursor-pointer hover:text-blue-800 transition" />
    </a>
    <a href="alimranbhuiya@gmail.com">
